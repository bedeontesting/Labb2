...
public class TankController : MonoBehaviour
{
    ...
    public float m_WheelRotateSpeed = 3f;
    ...
    private void RotateWheels()
    {
        ...
        // Your code here
        Quaternion wheelRotation = Quaternion.Euler(0f, 0f, 0f);

        if (m_MovementInputValue > 0)
        {
            wheelRotation = Quaternion.Euler(-m_WheelRotateSpeed, 0f, 0f);
        ...
        {
            m_wheels[i].transform.localRotation *= wheelRotation;
        }
    ...
    private void RotateTurret()
    {
        ...
        {
            Vector3 floorHitDirection = floorHit.point - m_turret.transform.position;
            floorHitDirection.y = 0f; // Set y value to 0 in order to not rotate vertically towards hit point
            m_turret.transform.rotation = Quaternion.LookRotation(floorHitDirection);
        }
    }
}
